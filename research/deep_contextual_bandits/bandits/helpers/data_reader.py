...
class DataReader(object):
    ...
    def __init__(self, path):
        ...
        attributes_to_set = ['test_name','num_actions','context_dim','nb_contexts','cum_rew','cum_reg','algo_details']
        ...
        if "bound method HParams" in self.algo_details: # for old version of benchmarker
            self.algo_names = [s[s.rfind("'")+1:] for s in self.algo_details.split("', <bound method HParams.to_json")[:-1]]
        else:
